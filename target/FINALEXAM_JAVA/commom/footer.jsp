            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="item">
                        ...
                        <h1> Manufacturer <br> <span>warranty</span></h1>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3">
                    <div class="item">
            ...
            <div class="col-sm-3 col-md-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li><a href="#English"> <img src="<c:url value='/WebContent/img/flags/gb.png'/>" alt="Eng"/> English</a></li>
                        <li><a href="#Spanish"> <img src="<c:url value='/WebContent/img/flags/es.png'/>" alt="Spa"/> Spanish</a></li>
                        <li><a href="#Deutch"> <img src="<c:url value='/WebContent/img/flags/de.png'/>" alt="De"/> Deutch</a></li>
                        <li><a href="#French"> <img src="<c:url value='/WebContent/img/flags/fr.png'/>" alt="Fr"/> French</a></li>
                    </ul>
                </div>
                <hr class="offset-xs">
        ...
        <div class="row">
            <div class="col-sm-8 col-md-9 payments">
                ...
                <div class="payment-icons">
                    <img src="<c:url value='/WebContent/img/payments/paypal.svg'/>" alt="paypal">
                    <img src="<c:url value='/WebContent/img/payments/visa.svg'/>" alt="visa">
                    <img src="<c:url value='/WebContent/img/payments/master-card.svg'/>" alt="mc">
                    <img src="<c:url value='/WebContent/img/payments/discover.svg'/>" alt="discover">
                    <img src="<c:url value='/WebContent/img/payments/american-express.svg'/>" alt="ae">
                </div>
                <br>
