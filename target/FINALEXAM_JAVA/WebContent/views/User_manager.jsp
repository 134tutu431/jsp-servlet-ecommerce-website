    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="btn-group " >
                        <button style="width: 180px;height: 33px;color: black;background: #d9d9d9" type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-sort" style="margin-left: 20px"></i> Sorting by ...
                        </button>
                        <ul class="dropdown-menu" >
                            <li ><a href="${pageContext.request.contextPath}/UserOder?oderby=nameasc"> <i class="ion-arrow-down-c"></i> Name [A-Z]</a></li>
                            <li ><a href="${pageContext.request.contextPath}/UserOder?oderby=namedesc"> <i class="ion-arrow-up-c"></i> Name [Z-A]</a></li>
                            <li ><a href="${pageContext.request.contextPath}/UserOder?oderby=idasc"> <i class="ion-arrow-down-c"></i> ID [Low-High]</a></li>
                            <li ><a href="${pageContext.request.contextPath}/UserOder?oderby=iddesc"> <i class="ion-arrow-up-c"></i> ID [High-Low]</a></li>
                        </ul>
                    </div>
        ...
        <form action="Usermanager" class="form-inline" method="post">
            ...
            <label style="margin-left: 535px;font-size: 18px;margin-bottom: 1px">Total Users : </label>
        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${listuser}" var="user">
                <tr>
                    <td>
                                    <span class="custom-checkbox">
                                        <input type="checkbox" id="checkbox${user.id}" name="options[]" value="${pro.id}">
                    ...
                    <td>
                        ...
                        <c:if test="${user.role == 0}">Guest</c:if>
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/EditUser?userid=${user.id}" class="edit" data-toggle="modal"><i class="fas fa-edit" data-toggle="tooltip"title="Edit Role"></i></a>
                        <a href="${pageContext.request.contextPath}/DeleteUser?userid=${user.id}" class="delete" data-toggle="modal"><i class="fas fa-trash-alt" data-toggle="tooltip" title="Delete"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
